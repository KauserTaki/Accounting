...
@section('content')
    {!! Form::open([
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                <!-- ardites $id = null, $parameters = [], $domain = 'messages', $locale = null-->
                    {{ Form::textGroup('id', trans('Identity'), old('id'), []) }}
...
@push('scripts_start')
    ...
    <script src="{{ asset('modules/Employees/Resources/assets/js/employees/create.min.js?v=' . module_version('employees')) }}"></script>
@endpush
