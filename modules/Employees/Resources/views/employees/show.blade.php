...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- ardites -->
            <!-- {{ !empty($employee->contact) ? $employee->company->name[0] : '-' }}{{$employee->position->name[0]}}{{$employee->contact->name[0]}}{{str_pad($employee->contact->id, 5, '0', STR_PAD_LEFT)}} -->
                    ...
                    <div class="card">
                        <div class="col-sm-8 col-md-6 col-lg-5 col-xl-4 mb-3">
                            ...
                            <div class="card-header border-bottom-0">
                                <b class="text-sm font-weight-600">{{ trans('Official ID') }}</b> <a class="float-right text-xs">{{$employee->company->name[0]}}{{$employee->position->name[0]}}{{ $employee->contact->name[0]}}{{str_pad($employee->contact->id, 5, '0', STR_PAD_LEFT)}}</a>
                            </div>
