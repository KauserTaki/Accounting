...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                {{ Form::textGroup('id', trans('Identity'), 'id', [], $employee->contact->id) }}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                {{ Form::moneyGroup('amount', trans('general.amount'), 'money-bill-alt', ['required' => 'required', 'currency' => $currency, 'dynamic-currency' => 'currency'], $employee->amount) }}
...
@push('scripts_start')
    ...
    <script src="{{ asset('modules/Employees/Resources/assets/js/employees/edit.min.js?v=' . module_version('employees')) }}"></script>
@endpush
